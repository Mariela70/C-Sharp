...
namespace Gyms.Tests
{
    public class GymsTests
    {
        ...
        {
            Athlete athlete = new Athlete("Mariela");
            Assert.AreEqual("Mariela", athlete.FullName);
            Assert.AreEqual(false, athlete.IsInjured);
        }
        [Test]
        public void Test_Gym_Creation()
        {
            Gym gym = new Gym("Power", 15);
            Assert.AreEqual("Power", gym.Name);
        ...
        public void Test_Gym_Add_Athlete_Works()
        {
            ...
            var athlete = new Athlete("Meri");
            var athlete2 = new Athlete("Ceco");
        ...
        [Test]
        public void Test_Gym_Add_Athlete_With_Fill_Capacity_Throws()
        {
            Gym gym = new Gym("Gym", 1);
            var athlete = new Athlete("Meri");
            var athlete2 = new Athlete("Ceco");
        ...
        public void Test_Gym_Report_When_Injured_Are_Not_Returned()
        {
            ...
            Assert.AreEqual("Active athletes at Gym: Ceco", gym.Report());
        ...
        public void Test_Gym_Report_When_All_Healthy_Are_Returned()
        {
            ...
            var report = gym.Report();
            Assert.AreEqual("Active athletes at Gym: Meri, Ceco", gym.Report());


        }
        [Test]
        public void Test_Gym_Report_With_Empty_GymWorks()
        {
            Gym gym = new Gym("Gym", 3);
